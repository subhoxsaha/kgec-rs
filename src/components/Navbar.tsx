                ...
                {googleUser ? (
                  ...
                  <div className="space-y-1.5">
                    ...
                    <button
                      ...
                      className="w-full py-1.5 px-2.5 rounded-xl bg-emerald-600/10 hover:bg-emerald-600/20 text-emerald-800 dark:text-emerald-300 border border-emerald-500/25 text-xs font-semibold transition-all shadow-2xs flex items-center justify-between cursor-pointer group"
                    >
                      <div className="flex items-center gap-2">
                        <UserPlus className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400 shrink-0" />
                        <span>Join Society / Register</span>
                      </div>
