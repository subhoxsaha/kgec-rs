...
export const BOT_QUICK_QUESTIONS: BotQuickQuestion[] = [
    ...
    followUps: [
      {
        ...
        navTarget: '#wings-section',
        navLabel: 'View Recruitment & Tech Wings →',
      },
      {
        id: 'krs-achievements',
        label: 'Achievements',
  ...
  },
  {
    ...
    navTarget: '#wings-section',
    navLabel: 'Explore 4 Technical Divisions →',
    ...
    followUps: [
      ...
      },
      {
        ...
        navTarget: '#roadmap-section',
        navLabel: 'View Society Timeline →',
      },
    ],
  },
  {
    ...
    label: 'Core Domains',
    category: 'Wings',
    title: 'Multi-Disciplinary Tech Wings',
    ...
    navTarget: '#wings-section',
    navLabel: 'View Technical Wings & Specs →',
    ...
    followUps: [
      ...
      },
      {
        ...
        navTarget: '#wings-section',
        navLabel: 'Explore Embedded Wing →',
      },
    ],
  },
  {
    ...
    followUps: [
      {
        ...
        navTarget: '#wings-section',
        navLabel: 'View Mechatronics Wing →',
      },
      {
        id: 'ws-ros',
